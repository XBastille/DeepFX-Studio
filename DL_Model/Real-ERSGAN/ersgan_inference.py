...
def upscale_image(input_path, output_path, model_name='RealESRGAN_x4plus'):
    if model_name == 'RealESRGAN_x4plus':
        ...
        netscale = 4
        file_url = ['https://github.com/XBastille/DeepFX-Studio/releases/download/model_2/realesr-general-wdn-x4v3.pth']
    elif model_name == 'RealESRGAN_x4plus_anime_6B':
        model = RRDBNet(num_in_ch=3, num_out_ch=3, num_feat=64, num_block=6, num_grow_ch=32, scale=4)
        netscale = 4
        file_url = ['https://github.com/XBastille/DeepFX-Studio/releases/download/model_2/RealESRGAN_x4plus_anime_6B_netD.pth']
