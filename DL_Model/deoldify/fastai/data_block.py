...
class ItemList:
    ...
    def from_folder(
        ...
        **kwargs,
        ...
        return cls(
            get_files(
                path, extensions, recurse=recurse, include=include, presort=presort
            ),
            path=path,
            processor=processor,
            **kwargs,
...
class LabelList(Dataset):
    ...
    def __getitem__(self, idxs: Union[int, np.ndarray]) -> "LabelList":
        ...
        if isinstance(idxs, Integral):
            ...
            if hasattr(self, "tfms_y") and self.tfm_y and self.item is None:
                y = y.apply_tfms(
                    self.tfms_y, is_x=False, **{**self.tfmargs_y, "do_resolve": False}
                )
            if y is None:
                y = 0
            return x, y
    ...
    def process(
        self, xp: PreProcessor = None, yp: PreProcessor = None, name: str = None
    ):
