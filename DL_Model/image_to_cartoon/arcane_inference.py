...
def scale_by_face_size(_img, max_res=1_500_000, target_face=256, fix_ratio=0, max_upscale=2):
    boxes, _ = detect(_img)
...
def process_image(input_path, model_path):
    ...
    input_image = scale_by_face_size(input_image, target_face=300, max_res=1_500_000, max_upscale=2)
