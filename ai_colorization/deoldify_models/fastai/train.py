...
def fit_one_cycle(
    ...
    learn.fit(
        cyc_len, max_lr, wd=wd, callbacks=callbacks, batch_multiplier=batch_multiplier
    )
...
def lr_find(
    ...
    learn.fit(
        epochs, start_lr, callbacks=[cb], wd=wd, batch_multiplier=batch_multiplier
    )
...
class ClassificationInterpretation(Interpretation):
    ...
    def __init__(
        ...
        super(ClassificationInterpretation, self).__init__(
