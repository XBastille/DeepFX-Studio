...
class IAAAffine2(A.DualTransform):
    ...
    def __init__(
        ...
        self.translate_percent = A.to_tuple(translate_percent, 0)
        self.translate_px = A.to_tuple(translate_px, 0)
        self.rotate = A.to_tuple(rotate)
...
class IAAPerspective2(A.DualTransform):
    ...
    def __init__(
        ...
        self.scale = A.to_tuple(scale, 1.0)
